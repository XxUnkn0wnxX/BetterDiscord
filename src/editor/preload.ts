...
const editor = {
    ...
    open() {
        electron.shell.openPath(filepath).then((error) => {
            // Upstream 44e21745 closes on every resolved result, but Electron resolves failures to an error string.
            // Keep this editor open unless the system editor actually launched.
