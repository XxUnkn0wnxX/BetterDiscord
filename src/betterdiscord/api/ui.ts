        ...
        if (setting.type === "category") {
            ...
            return React.createElement(Group, {
                ...
                settings: setting.settings.map((x) => {
                    ...
                    // Fork review note: upstream 44e21745 inverted these nested category checks.
                    // Match its top-level/SettingsStore semantics unless upstream confirms different category behavior:
                    // enableWith disables while its controller is off; disableWith disables while its controller is on.
