...
export default function CssEditor({
    ...
    useLayoutEffect(() => {
        // Fork review: upstream 44e21745 applies the full-page classes to every editor.
        ...
        return () => {
            ...
            // Fork review: remove the class from the same scroller that received it.
            scroller.classList.remove("bd-custom-css-page-scroller");
